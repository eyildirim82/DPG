        ...
        >
            <div className="text-center mb-8 md:mb-12">
              ...
              <div className="flex flex-wrap md:flex-nowrap items-center justify-center gap-3 md:gap-6 max-w-[1000px] mx-auto py-2">
                  <a href="https://www.talpa.org/haber/denizbank/" target="_blank" rel="noopener noreferrer" className="bg-white rounded-xl border border-white/10 p-4 flex items-center justify-center w-[calc(50%-0.375rem)] h-[80px] md:w-[160px] md:h-[100px] flex-shrink-0 transition-all duration-300 hover:scale-105 hover:bg-white/90 cursor-pointer overflow-hidden">
                    <img
                ...
                <a href="https://northernland.com/tr/grand-sapphire-blu" target="_blank" rel="noopener noreferrer" className="bg-white rounded-xl border border-white/10 p-1 flex items-center justify-center w-[calc(50%-0.375rem)] h-[80px] md:w-[160px] md:h-[100px] flex-shrink-0 transition-all duration-300 hover:scale-105 hover:bg-white/90 cursor-pointer overflow-hidden">
                    <img
