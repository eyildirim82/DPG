...
export default function Button({ children, onClick, secondary, style = {}, type = 'button', className = '' }) {
  const base =
    'px-10 py-4 font-body uppercase tracking-widest text-[20px] cursor-pointer transition-all duration-300 ease-out relative overflow-hidden inline-block min-h-[60px] focus-visible:outline focus-visible:outline-2 focus-visible:outline-dpg-gold focus-visible:outline-offset-2 active:scale-95';
